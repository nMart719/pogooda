...
export class WeatherControllerApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getHistoryWeatherInfo operation.
     * @callback moduleapi/WeatherControllerApi~getHistoryWeatherInfoCallback
     * @param {String} error Error message, if any.
    ...
    /**
     * @param {module:api/WeatherControllerApi~getHistoryWeatherInfoCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getHistoryWeatherInfo(callback) {
